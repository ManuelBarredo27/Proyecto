...
public class RestaLevel extends JPanel implements KeyListener {
		
		JFrame window = new JFrame("Nivel de resta");
		...
		int count = 0;
		DropperR dropper = new DropperR(this,ghosts);
		...
		RestaLevel() {
			...
			try {
				File sound = new File("sounds//modem1.wav");
		...
		public void paint(Graphics g) {
			ImageIcon background = new ImageIcon("images/resta.jpg");
			...
			g.drawString("Score: "+FireR.score, 135, 20);
			levelFailed();
			levelComplete();
		...
		public void keyPressed(KeyEvent kp) {
			...
			else if(kp.getKeyCode()==KeyEvent.VK_SPACE)
			{
				...
				FireR f = new FireR(bullets[count],this,ghosts);
