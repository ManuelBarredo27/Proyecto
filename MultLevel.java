...
public class MultLevel extends JPanel implements KeyListener {
		
		JFrame window = new JFrame("Nivel de Multiplicacion");
		...
		int count = 0;
		DropperM dropper = new DropperM(this,ghosts);
		...
		MultLevel() {
			...
			try {
				File sound = new File("sounds//evil_risa.wav");
		...
		public void paint(Graphics g) {
			...
			g.drawString("Score: "+FireM.score, 135, 20);
			levelFailed();
			levelComplete();
		...
		public void keyPressed(KeyEvent kp) {
			...
			else if(kp.getKeyCode()==KeyEvent.VK_SPACE)
			{
				...
				FireM f = new FireM(bullets[count],this,ghosts);
